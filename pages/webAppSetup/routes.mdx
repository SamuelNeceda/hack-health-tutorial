...
## Login route
**The implementation of login route is very analogous to the register route.**
...
<Callout emoji="💡">
    Similarly as register route, you can test login route using predefined request in Postman. You can try to login with email and password of the user you have just registered. <br />
