...
Please, log into the TUKE Microsoft account and download the image of the VM from Microsoft OneDrive [storage](https://tukesk-my.sharepoint.com/:u:/g/personal/samuel_neceda_student_tuke_sk/EaDBokMovUxPnPftMf1GueMB6CzDTNhZ7_FaGJDJkj4N-w?e=9TiCXB). <br/>
...
You have complete freedom to customize the VM and tools to your needs, but _'With great power comes great responsibility'_ (Stan Lee).
...
<Callout type="info" emoji="ℹ️">
  OS is Kali Linux 2022.4 which comes with preinstalled tools for web app
  penetration testing.
</Callout>
