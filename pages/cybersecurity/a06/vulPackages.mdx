...
<Callout emoji="💡">
    You can pick any of your personal/school project and try to apply the checklist below. If the check is fulfilled, you can **mark it as done** by clicking the checkbox on the left of the description.
</Callout>
