...
<Callout type="warning" emoji="⚠️">
    Sometimes, when the Google Chrome is opened automatically after running the command, you might lost internet connection. In that case, you can try to restart your connection or just close the VM with option `Save state` and open it again. This should resolve this unpredictable issue.
</Callout>
...
<Callout type="info" emoji="ℹ️">
    ...
    During the course, we will be addressing also the issues found be Snyk. At the end of the course, we should have fixed majority of the vulnerabilities found by Snyk.
</Callout>
