...
<Image src="/codeAnalysis/snyk_auth.png" alt="Snyk auth" width={1000} height={300}/>
<br/>
After successful logn/registration, just click on `Authenticate` button and return to the terminal.
<Image src="/codeAnalysis/snyk_cli_auth.png" alt="Snyk auth" width={1000} height={300}/>
...
<Image src="/codeAnalysis/snyk_code.png" alt="Snyk auth" width={1000} height={300}/>
