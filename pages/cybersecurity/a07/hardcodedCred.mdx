...
2. We will move all hardcoded credentials into `.env` file as environment variables.
...
4. In the following files, replace the hardcoded credentials with environment variables: <br />
**Files:**
    * dbCreate.ts
    * dbDrop.ts
    * dbSeed.ts
