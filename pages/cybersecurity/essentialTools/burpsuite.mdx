...
During this tutorial, we will be using tools:
* Proxy
* Intruder

**Proxy** is an intercepting proxy that gives us the power to see and modify the contents of the requests
and responses while they are in transit. <br />
**Intruder** is a tool that allows us to perform automated attacks on web applications. It allows us to
brute-force on login forms, and dictionary attacks on fields suspected of being vulnerable to XSS or SQL injection, ...
...
7. Try to log in with the correct credentials. <br/>
    After hitting the "Login" button, nothing really happens in the HackHealth app. <br/>
